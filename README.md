# genpark-fullstack-env-variable-drift-resolver-skill
...
**genpark-fullstack-env-variable-drift-resolver-skill** is a deterministic, zero-dependency Python skill engineered for autonomous full-stack vibe coding, AST-level frontend component patching, and hydration exception triage.

> **Executive Capability**: Full-stack cross-tier environment variable drift auditor (Bolt.new / Supabase)
...
result = client.audit_and_sync_env_vars()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-fullstack-env-variable-drift-resolver-skill": {
      "command": "python",
      "args": ["/path/to/genpark-fullstack-env-variable-drift-resolver-skill/mcp_server.py"]
    }
  }
}
```
